...
enum LOCAL_VIDEO_EVENT_TYPE {
  /**
   * 1: (Android and iOS only) The screen capture window is hidden.
   */
  LOCAL_VIDEO_EVENT_TYPE_SCREEN_CAPTURE_WINDOW_HIDDEN = 1,
  /**
   * 2: (Android and iOS only) The screen capture window is recovered from hidden.
   */
...
enum PERMISSION_TYPE {
  ...
  CAMERA = 1,
  /**
   * 2: Permission for screen capture.
   */
  SCREEN_CAPTURE = 2,
};
