 ...
 */
   ...
   *  - true: Successfull preload the Rte URL.
   ...
   *  - true: Successfull get the configuration.
   ...
   *  - true: Successfull set the configuration.
   ...
   *  - true: Successfull register the observer.
 ...
 *  - true: Successfull unregister the observer.
