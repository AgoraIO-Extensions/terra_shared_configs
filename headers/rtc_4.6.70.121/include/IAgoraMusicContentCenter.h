...
typedef enum {
    /**
     * 0: The music content center preloads successfully.
     */
    kMusicContentCenterStatePreloadOk = 0,
    /**
     * 1: The music content center preload fails.
     */
    kMusicContentCenterStatePreloadFailed = 1,
    /**
     * 2: The music content center is preloading.
     */
    kMusicContentCenterStatePreloading = 2,
    /**
     * 3: The music content center preload is removed.
     */
    kMusicContentCenterStatePreloadRemoved = 3,
    /**
     * 4: The music content center starts scoring successfully.
     */
    kMusicContentCenterStateStartScoreCompleted = 4,
    /**
     * 5: The music content center starts scoring fails.
     */
...
// The level of the score, The higher the level, the more difficult it is
typedef enum {
    kScoreLevel1 = 1,
    kScoreLevel2 = 2,
    kScoreLevel3 = 3,
...
struct RawScoreData {
     ...
     */
    float pitchScore = 0;
    RawScoreData(): progressInMs(0), speakerPitch(0.0), pitchScore(0.0) {}
};
...
struct LineScoreData {
     ...
     */
    float energyScore;
    LineScoreData(): progressInMs(0), index(0), totalLines(0), pitchScore(0.0), cumulativePitchScore(0.0), energyScore(0.0) {}
};
...
struct CumulativeScoreData {
     ...
     */
    float energyScore;
    CumulativeScoreData(): progressInMs(0), cumulativePitchScore(0.0), energyScore(0.0) {}
};
...
public:
     ...
     */
    virtual void onPitch(int64_t internalSongCode, RawScoreData &rawScoreData) = 0;
    /**
     * The callback when the score of the line is detected.
     */
    virtual void onLineScore(int64_t internalSongCode, LineScoreData &lineScoreData) = 0;
...
public:
     ...
     *
     * @param requestId Request ID. A unique identifier for this request.
     * @param internalSongCode The ID of the music resource, used to identify the music.
     * @param payload  The payload of the music.
     * @param reason The request status code from the Music Content Center. See
     * `MusicContentCenterStateReason`.
     *
     */
    ...
    /**
     * Lyric info callback of getLyricInfo, occurs when getLyricInfo is called
     * 
     * @param requestId The request id is same as that returned by getLyricInfo.
     * @param internalSongCode The ID of the music resource, used to identify the music.
     * @param lyricInfo The lyric info of the music.
     * @param reason The reason of the request. See MusicContentCenterStateReason
     */
    virtual void onLyricInfoResult(const char* requestId, int64_t internalSongCode, agora_refptr<ILyricInfo> lyricInfo, MusicContentCenterStateReason reason) = 0;
     ...
     *
     */
    virtual void onSongSimpleInfoResult(const char* requestId, int64_t internalSongCode, const char* simpleInfo, MusicContentCenterStateReason reason) = 0;
     ...
     *
     * @param requestId Request ID. A unique identifier for this request.
     * @param internalSongCode The ID of the music resource, used to identify a music item.
     * @param percent Current loading progress of the music resource, ranging from [0, 100].
     * @param payload  The payload of the music.
     * @param state Current loading state of the music resource. See `MusicContentCenterState`.
     * @param reason Request status code from the Music Content Center. See
     * `MusicContentCenterStateReason`.
     *
     */
    virtual void onPreLoadEvent(const char* requestId, int64_t internalSongCode, int percent, const char* payload, MusicContentCenterState state, MusicContentCenterStateReason reason) = 0;
    
    /**
     * Score result callback, occurs when startScore is called
     * 
     * @param internalSongCode The ID of the music resource, used to identify a music item.
     * @param state The state of the request. See MusicContentCenterState
     * @param reason The reason of the request. See MusicContentCenterStateReason
     */
    virtual void onStartScoreResult(int64_t internalSongCode,  MusicContentCenterState state, MusicContentCenterStateReason reason) = 0;
...
struct MusicContentCenterVendor2Configuration {
    ...
    const char* userId;
    /**
     * The room ID of the vendor2 that has enabled the music content center
     */
    const char* roomId;
    /**
...
public:
     ...
     *
     * @param vendorId The vendor id. See `MccVendorID`.
     ...
     *
     * @param eventHandler The event handler to unregister. See `IMusicContentCenterEventHandler`.
     *
     * @return
     * - 0: Success.
     * - < 0: Failure. See `Error Codes` for details and resolution suggestions.
     ...
     * receiving the `onPreLoadEvent` callback.
     *
     * @param internalSongCode The song code of the music resource, used to identify the music.
    ...
    */
     ...
     *
     * @param internalSongCode The ID of the music resource to be deleted.
     *
     * @return
     ...
     * - < 0: Failure. See `Error Codes` for details and resolution suggestions.
     */
    virtual int getLyric(agora::util::AString& requestId, int64_t internalSongCode, LyricSourceType lyricType = kLyricSourceXml) = 0;
     ...
     * resource.
     *
     * @param vendorId The vendor id of the music resource. See `MccVendorID`.
