...
public:
    ...
    */
     ...
     * @param cacheInfoSize  Pass in the number of the cached media files that you want to get. If the number you pass exceeds the actual number of cached media files, the value you get is the actual number of the cached files; otherwise, it is the number of the file you want to get.
     * @return
     * - 0: Success.
     * - < 0: Failure.
     */
