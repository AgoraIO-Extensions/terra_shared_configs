...
class IRtcEngineEx {
  ...
  /**
   * @iris_api_id: RtcEngineEx_addVideoWatermarkEx_ad7daa3
   * @source: virtual int addVideoWatermarkEx(const char* watermarkUrl, const WatermarkOptions& options, const RtcConnection& connection) = 0;
   */
