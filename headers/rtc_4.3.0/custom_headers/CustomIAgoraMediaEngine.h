...
class IMediaEngineS {
  ...
  // add for registerAudioFrameObserver
  // virtual int registerAudioFrameObserver(IAudioFrameObserver* observer) = 0;
  virtual int unregisterAudioFrameObserver(IAudioFrameObserverBase *observer) = 0;

  // add for registerVideoFrameObserver
  // virtual int registerVideoFrameObserver(IVideoFrameObserver* observer) = 0;
  virtual int unregisterVideoFrameObserver(IVideoFrameObserverS *observer) = 0;

  // add for registerVideoEncodedFrameObserver
  // virtual int registerVideoEncodedFrameObserver(IVideoEncodedFrameObserver* observer) = 0;
  virtual int
  unregisterVideoEncodedFrameObserver(IVideoEncodedFrameObserverS *observer) = 0;
