...
struct LiveTranscodingS : public LiveTranscodingBase {
   ...
   */
  TranscodingUserS* transcodingUsersS;

  LiveTranscodingS() : userCount(0), transcodingUsersS(OPTIONAL_NULLPTR) {}
};
...
struct LocalTranscoderConfigurationS : public LocalTranscoderConfigurationBase {
   ...
   */
  TranscodingVideoStreamS* videoInputStreamsS;

  LocalTranscoderConfigurationS() : streamCount(0), videoInputStreamsS(OPTIONAL_NULLPTR) {}
};
...
struct ChannelMediaRelayConfigurationS : public ChannelMediaRelayConfigurationBase {
   ...
   * and `uid`.
   */
  ChannelMediaInfoS* destInfosS;

  ChannelMediaRelayConfigurationS() : srcInfoS(OPTIONAL_NULLPTR), destInfosS(OPTIONAL_NULLPTR) {}
};
