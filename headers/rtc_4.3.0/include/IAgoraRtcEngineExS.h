...
struct RtcConnectionS {
  ...
  RtcConnectionS() : channelId(NULL), localUserAccount(NULL) {}
  RtcConnectionS(const char* channel_id, const char* local_user_account)
      : channelId(channel_id), localUserAccount(local_user_account) {}
};

class IRtcEngineEventHandlerExS : public IRtcEngineEventHandlerS {
 public:
  using IRtcEngineEventHandlerS::eventHandlerType;
  using IRtcEngineEventHandlerS::onJoinChannelSuccess;
  using IRtcEngineEventHandlerS::onRejoinChannelSuccess;
  using IRtcEngineEventHandlerS::onAudioVolumeIndication;
  using IRtcEngineEventHandlerS::onLeaveChannel;
  using IRtcEngineEventHandlerS::onRtcStats;
  using IRtcEngineEventHandlerS::onNetworkQuality;
  using IRtcEngineEventHandlerS::onIntraRequestReceived;
  using IRtcEngineEventHandlerS::onFirstLocalVideoFrame;
  using IRtcEngineEventHandlerS::onFirstLocalVideoFramePublished;
  using IRtcEngineEventHandlerS::onVideoSizeChanged;
  using IRtcEngineEventHandlerS::onLocalVideoStateChanged;
  using IRtcEngineEventHandlerS::onRemoteVideoStateChanged;
  using IRtcEngineEventHandlerS::onFirstRemoteVideoFrame;
  using IRtcEngineEventHandlerS::onUserJoined;
  using IRtcEngineEventHandlerS::onUserOffline;
  using IRtcEngineEventHandlerS::onUserMuteAudio;
  using IRtcEngineEventHandlerS::onUserMuteVideo;
  using IRtcEngineEventHandlerS::onUserEnableVideo;
  using IRtcEngineEventHandlerS::onUserStateChanged;
  using IRtcEngineEventHandlerS::onLocalAudioStats;
  using IRtcEngineEventHandlerS::onRemoteAudioStats;
  using IRtcEngineEventHandlerS::onLocalVideoStats;
  using IRtcEngineEventHandlerS::onRemoteVideoStats;
  using IRtcEngineEventHandlerS::onConnectionLost;
  using IRtcEngineEventHandlerS::onStreamMessage;
  using IRtcEngineEventHandlerS::onStreamMessageError;
  using IRtcEngineEventHandlerS::onRequestToken;
  using IRtcEngineEventHandlerS::onTokenPrivilegeWillExpire;
  using IRtcEngineEventHandlerS::onLicenseValidationFailure;
  using IRtcEngineEventHandlerS::onFirstLocalAudioFramePublished;
  using IRtcEngineEventHandlerS::onLocalAudioStateChanged;
  using IRtcEngineEventHandlerS::onRemoteAudioStateChanged;
  using IRtcEngineEventHandlerS::onActiveSpeaker;
  using IRtcEngineEventHandlerS::onClientRoleChanged;
  using IRtcEngineEventHandlerS::onClientRoleChangeFailed;
  using IRtcEngineEventHandlerS::onConnectionStateChanged;
  using IRtcEngineEventHandlerS::onWlAccMessage;
  using IRtcEngineEventHandlerS::onWlAccStats;
  using IRtcEngineEventHandlerS::onNetworkTypeChanged;
  using IRtcEngineEventHandlerS::onEncryptionError;
  using IRtcEngineEventHandlerS::onUploadLogResult;
  using IRtcEngineEventHandlerS::onAudioSubscribeStateChanged;
  using IRtcEngineEventHandlerS::onVideoSubscribeStateChanged;
  using IRtcEngineEventHandlerS::onAudioPublishStateChanged;
  using IRtcEngineEventHandlerS::onVideoPublishStateChanged;
  using IRtcEngineEventHandlerS::onSnapshotTaken;
  using IRtcEngineEventHandlerS::onVideoRenderingTracingResult;
  using IRtcEngineEventHandlerS::onSetRtmFlagResult;

  virtual const char* eventHandlerType() const { return "event_handler_ex_s"; }
   ...
   *
   * @param connectionS The RtcConnectionS object.
   * @param elapsed The time elapsed (ms) from the local user calling joinChannel until the SDK triggers this callback.
   */
  virtual void onJoinChannelSuccess(const RtcConnectionS& connectionS, int elapsed) {
    (void)connectionS;
    (void)elapsed;
  }
   ...
   *
   * When a user loses connectionS with the server because of network problems, the SDK automatically tries to reconnect
   * and triggers this callback upon reconnection.
   *
   * @param connectionS The RtcConnectionS object.
   * @param elapsed Time elapsed (ms) from the local user calling the joinChannel method until this callback is triggered.
   */
  virtual void onRejoinChannelSuccess(const RtcConnectionS& connectionS, int elapsed) {
    (void)connectionS;
    (void)elapsed;
  }
   ...
   */
  virtual void onAudioVolumeIndication(const RtcConnectionS& connectionS, const AudioVolumeInfoS* speakersS,
   ...
   */
  virtual void onLeaveChannel(const RtcConnectionS& connectionS, const RtcStats& stats) {
    (void)connectionS;
    (void)stats;
  }
   ...
   */
  virtual void onRtcStats(const RtcConnectionS& connectionS, const RtcStats& stats) {
    (void)connectionS;
    (void)stats;
  }
   ...
   * connectionS between the local device and Agora's edge server.
   *
   ...
   *
   * @param connectionS The RtcConnectionS object.
   * @param userAccount The user account. The network quality of the user with this user ID is reported.
   ...
   */
  virtual void onNetworkQuality(const RtcConnectionS& connectionS, const char* remoteUserAccount, int txQuality, int rxQuality) {
    (void)connectionS;
   ...
   * @param connectionS The RtcConnectionS object.
   */
  virtual void onIntraRequestReceived(const RtcConnectionS& connectionS) {
    (void)connectionS;
  }
   ...
   * this callback.
  */
  virtual void onFirstLocalVideoFramePublished(const RtcConnectionS& connectionS, int elapsed) {
    (void)connectionS;
    (void)elapsed;
  }
  ...
  */
  virtual void onFirstRemoteVideoDecoded(const RtcConnectionS& connectionS, const char* remoteUserAccount, int width, int height, int elapsed) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)width;
    (void)height;
   ...
   */
  virtual void onVideoSizeChanged(const RtcConnectionS& connectionS, VIDEO_SOURCE_TYPE sourceType, const char* userAccount, int width, int height, int rotation) {
    (void)connectionS;
    (void)userAccount;
    (void)width;
    (void)height;
   ...
   */
  virtual void onLocalVideoStateChanged(const RtcConnectionS& connectionS,
   ...
   */
  virtual void onRemoteVideoStateChanged(const RtcConnectionS& connectionS, const char* userAccount, REMOTE_VIDEO_STATE state, REMOTE_VIDEO_STATE_REASON reason, int elapsed) {
    (void)connectionS;
    (void)userAccount;
    (void)state;
    (void)reason;
   ...
   * @param elapsed The time elapsed (ms) from the local user calling `joinChannel` until the SDK triggers this callback.
   */
  virtual void onFirstRemoteVideoFrame(const RtcConnectionS& connectionS, const char* userAccount, int width, int height, int elapsed) {
    (void)connectionS;
    (void)userAccount;
    (void)width;
    (void)height;
  ...
  */
  virtual void onUserJoined(const RtcConnectionS& connectionS, const char* userAccount, int elapsed) {
    (void)connectionS;
    (void)userAccount;
    (void)elapsed;
  }
   ...
   * that the user drops offline. A poor network connectionS may lead to false detection, so we recommend using
   ...
   */
  virtual void onUserOffline(const RtcConnectionS& connectionS, const char* userAccount, USER_OFFLINE_REASON_TYPE reason) {
    (void)connectionS;
    (void)userAccount;
    (void)reason;
  }
   ...
   * - false: Unmuted.
   */
 virtual void onUserMuteAudio(const RtcConnectionS& connectionS, const char* remoteUserAccount, bool muted) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)muted;
  }
   ...
   */
 virtual void onUserMuteVideo(const RtcConnectionS& connectionS, const char* remoteUserAccount, bool muted) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)muted;
  }
  ...
  */
  virtual void onUserEnableVideo(const RtcConnectionS& connectionS, const char* remoteUserAccount, bool enabled) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)enabled;
  }
   ...
   *
   * @param connectionS The RtcConnectionS object.
   * @param remoteUserAccount The ID of the remote user.
   * @param state The remote user state: #REMOTE_USER_STATE.
   */
  virtual void onUserStateChanged(const RtcConnectionS& connectionS, const char* remoteUserAccount, uint32_t state) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)state;
  }
   ...
   * See LocalAudioStats.
   */
  virtual void onLocalAudioStats(const RtcConnectionS& connectionS, const LocalAudioStats& stats) {
    (void)connectionS;
    (void)stats;
  }
   ...
   */
  virtual void onRemoteAudioStats(const RtcConnectionS& connectionS, const RemoteAudioStatsS& statsS) {
    (void)connectionS;
    (void)statsS;
  }
   ...
   */
  virtual void onLocalVideoStats(const RtcConnectionS& connectionS, const LocalVideoStatsS& statsS) {
    (void)connectionS;
    (void)statsS;
  }
   ...
   * RemoteVideoStats.
   */
  virtual void onRemoteVideoStats(const RtcConnectionS& connectionS, const RemoteVideoStatsS& statsS) {
    (void)connectionS;
    (void)statsS;
  }

  /**
   * Occurs when the SDK cannot reconnect to the server 10 seconds after its connectionS to the server is
   * interrupted.
   *
   ...
   * @param connectionS The RtcConnectionS object.
   */
  virtual void onConnectionLost(const RtcConnectionS& connectionS) {
    (void)connectionS;
  }

  /** Occurs when your connectionS is banned by the Agora Server.
   *
   * @param connectionS The RtcConnectionS object.
   */
  virtual void onConnectionBanned(const RtcConnectionS& connectionS) {
    (void)connectionS;
  }
   ...
   */
  virtual void onStreamMessage(const RtcConnectionS& connectionS, const char* remoteUserAccount, int streamId, const char* data, size_t length, uint64_t sentTs) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)streamId;
    (void)data;
   ...
   * interrupted.
   */
  virtual void onStreamMessageError(const RtcConnectionS& connectionS, const char* remoteUserAccount, int streamId, int code, int missed, int cached) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)streamId;
    (void)code;
   ...
   * @param connectionS The RtcConnectionS object.
   */
  virtual void onRequestToken(const RtcConnectionS& connectionS) {
    (void)connectionS;
  }

  /**
   * Occurs when connectionS license verification fails.
   *
   * You can know the reason accordding to error code
   */
  virtual void onLicenseValidationFailure(const RtcConnectionS& connectionS, LICENSE_ERROR_TYPE reason) {
    (void)connectionS;
    (void)reason;
  }
   ...
   */
  virtual void onTokenPrivilegeWillExpire(const RtcConnectionS& connectionS, const char* token) {
    (void)connectionS;
    (void)token;
  }
   ...
   */
  virtual void onFirstLocalAudioFramePublished(const RtcConnectionS& connectionS, int elapsed) {
    (void)connectionS;
    (void)elapsed;
  }
   ...
   */
  virtual void onLocalAudioStateChanged(const RtcConnectionS& connectionS, LOCAL_AUDIO_STREAM_STATE state, LOCAL_AUDIO_STREAM_ERROR error) {
    (void)connectionS;
    (void)state;
    (void)error;
  }
   ...
   */
  virtual void onRemoteAudioStateChanged(const RtcConnectionS& connectionS, const char* remoteUserAccount, REMOTE_AUDIO_STATE state, REMOTE_AUDIO_STATE_REASON reason, int elapsed) {
    (void)connectionS;
    (void)remoteUserAccount;
    (void)state;
    (void)reason;
   ...
   */
  virtual void onActiveSpeaker(const RtcConnectionS& connectionS, const char* userAccount) {
    (void)connectionS;
    (void)userAccount;
  }
   ...
   *
   * @param connectionS The RtcConnectionS of the local user: #RtcConnectionS
   ...
   */
  virtual void onClientRoleChanged(const RtcConnectionS& connectionS, CLIENT_ROLE_TYPE oldRole, CLIENT_ROLE_TYPE newRole, const ClientRoleOptions& newRoleOptions) {
    (void)connectionS;
    (void)oldRole;
    (void)newRole;
    (void)newRoleOptions;
   ...
   */
  virtual void onClientRoleChangeFailed(const RtcConnectionS& connectionS, CLIENT_ROLE_CHANGE_FAILED_REASON reason, CLIENT_ROLE_TYPE currentRole) {
    (void)connectionS;
    (void)reason;
    (void)currentRole;
  }

  /** Occurs when the network connectionS state changes.
   *
   * When the network connectionS state changes, the SDK triggers this callback and reports the current
   * connectionS state and the reason for the change.
   *
   * @param connectionS The RtcConnectionS object.
   * @param state The current connectionS state. See #CONNECTION_STATE_TYPE.
   * @param reason The reason for a connectionS state change. See #CONNECTION_CHANGED_REASON_TYPE.
   */
  virtual void onConnectionStateChanged(const RtcConnectionS& connectionS,
   ...
   */
  virtual void onWlAccMessage(const RtcConnectionS& connectionS, WLACC_MESSAGE_REASON reason, WLACC_SUGGEST_ACTION action, const char* wlAccMsg) {
    (void)connectionS;
    (void)reason;
    (void)action;
    (void)wlAccMsg;
   ...
   */
  virtual void onWlAccStats(const RtcConnectionS& connectionS, WlAccStats currentStats, WlAccStats averageStats) {
    (void)connectionS;
    (void)currentStats;
    (void)averageStats;
  }
   ...
   *
   * This callback occurs when the connectionS state of the local user changes. You can get the
   * connectionS state and reason for the state change in this callback. When the network connectionS
   ...
   * @param connectionS The RtcConnectionS object.
   * @param type The type of the local network connectionS. See #NETWORK_TYPE.
   */
  virtual void onNetworkTypeChanged(const RtcConnectionS& connectionS, NETWORK_TYPE type) {
    (void)connectionS;
    (void)type;
  }
   ...
   */
  virtual void onEncryptionError(const RtcConnectionS& connectionS, ENCRYPTION_ERROR_TYPE errorType) {
    (void)connectionS;
    (void)errorType;
  }
  /**
   ...
   */
  virtual void onUploadLogResult(const RtcConnectionS& connectionS, const char* requestId, bool success, UPLOAD_ERROR_REASON reason) {
    (void)connectionS;
    (void)requestId;
    (void)success;
    (void)reason;
   ...
   */
  virtual void onSnapshotTaken(const RtcConnectionS& connectionS, const char* userAccount, const char* filePath, int width, int height, int errCode) {
    (void)userAccount;
    (void)filePath;
    (void)width;
    (void)height;
   ...
   */
  virtual void onVideoRenderingTracingResult(const RtcConnectionS& connectionS, const char* userAccount, MEDIA_TRACE_EVENT currentEvent, VideoRenderingTracingInfo tracingInfo) {
    (void)userAccount;
    (void)currentEvent;
    (void)tracingInfo;
  }
  ...
  /**
   * Occurs when receive rtm setting change response.
   *
   * @param code The error code:
   */
  virtual void onSetRtmFlagResult(const RtcConnectionS& connectionS, int code) {
    (void)code;
  }
};

class IRtcEngineExS : public IRtcEngineS {
public:
   /**
    ...
    *
    * When the connectionS between the client and Agora's server is interrupted due to poor network
    ...
    * to invalid string, or the value of a member in the `ChannelMediaOptions` structure is invalid. You need
    ...
    */
    virtual int joinChannelEx(const char* token, const RtcConnectionS& connectionS,
                              const ChannelMediaOptions& options,
                              IRtcEngineEventHandlerS* eventHandlerS) = 0;
   ...
   * - < 0: Failure.
   */
    virtual int leaveChannelEx(const RtcConnectionS& connectionS) = 0;

    /**
     * Leaves the channel with the connectionS ID.
     *
     * @param connectionS The RtcConnectionS object.
     ...
     * - < 0: Failure.
     */
    virtual int leaveChannelEx(const RtcConnectionS& connectionS, const LeaveChannelOptions& options) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int updateChannelMediaOptionsEx(const ChannelMediaOptions& options, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setVideoEncoderConfigurationEx(const VideoEncoderConfiguration& config, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setupRemoteVideoEx(const VideoCanvasS& canvas, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int muteRemoteAudioStreamEx(const char* userAccount, bool mute, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * @param connectionS The RtcConnetionS object.
     *
     * @return
     * - 0: Success.
     * - < 0: Failure.
     */
    virtual int muteRemoteVideoStreamEx(const char* userAccount, bool mute, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setRemoteVideoStreamTypeEx(const char* userAccount, VIDEO_STREAM_TYPE streamType, const RtcConnectionS& connectionS) = 0;
    /**
     *Stops or resumes sending the local audio stream with connectionS.
     *
     ...
     *- < 0: Failure.
     */
    virtual int muteLocalAudioStreamEx(bool mute, const RtcConnectionS& connectionS) = 0;
  
    /**
     *Stops or resumes sending the local video stream with connectionS.
     *
     ...
     *- < 0: Failure.
     */
    virtual int muteLocalVideoStreamEx(bool mute, const RtcConnectionS& connectionS) = 0;
    
    /**
     *Stops or resumes receiving all remote audio stream with connectionS.
     *
     ...
     *- < 0: Failure.
     */
    virtual int muteAllRemoteAudioStreamsEx(bool mute, const RtcConnectionS& connectionS) = 0;
  
    /**
     *Stops or resumes receiving all remote video stream with connectionS.
     *
     *@param mute Whether to stop receiving remote audio streams:
     *- true: Stop receiving any remote audio stream.
     *- false: Resume receiving all remote audio streams.
     ...
     *- < 0: Failure.
     */
    virtual int muteAllRemoteVideoStreamsEx(bool mute, const RtcConnectionS& connectionS) = 0;
     ...
     *
     * @param userAccountList The id list of users who do not subscribe to audio.
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeAudioBlocklistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connectionS) = 0;
     ...
     *
     * @param userAccountList The id list of users who do subscribe to audio.
     * @param userAccountNumber The number of userAccount in userAccountList.
     * @param connectionS The RtcConnectionS object.
     *
     * @return
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeAudioAllowlistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connectionS) = 0;
     ...
     *
     * @param userAccountList The id list of users who do not subscribe to video.
     * @param userAccountNumber The number of userAccount in userAccountList.
     * @param connectionS The RtcConnectionS object.
     *
     * @return
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeVideoBlocklistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connectionS) = 0;
     ...
     *
     * @param userAccountList The id list of users who do subscribe to video.
     * @param userAccountNumber The number of userAccount in userAccountList.
     * @param connectionS The RtcConnectionS object.
     *
     * @return
     ...
     * - < 0: Failure.
     */
    virtual int setSubscribeVideoAllowlistEx(const char** userAccountList, int userAccountNumber, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setRemoteVideoSubscriptionOptionsEx(const char* userAccount, const VideoSubscriptionOptions& options, const RtcConnectionS& connectionS) = 0;
    ...
    - < 0: Failure.
    */
    virtual int setRemoteVoicePositionEx(const char* userAccount, double pan, double gain, const RtcConnectionS& connectionS) = 0;
    ...
    - < 0: Failure.
    */
    virtual int setRemoteUserSpatialAudioParamsEx(const char* userAccount, const agora::SpatialAudioParams& params, const RtcConnectionS& connectionS) = 0;
    /**
     ...
     * - < 0: Failure.
     */
    virtual int setRemoteRenderModeEx(const char* userAccount, media::base::RENDER_MODE_TYPE renderMode,
                                      VIDEO_MIRROR_MODE_TYPE mirrorMode, const RtcConnectionS& connectionS) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int enableLoopbackRecordingEx(const RtcConnectionS& connectionS, bool enabled, const char* deviceName = NULL) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int adjustRecordingSignalVolumeEx(int volume, const RtcConnectionS& connectionS) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int muteRecordingSignalEx(bool mute, const RtcConnectionS& connectionS) = 0;
     ...
     * - < 0: Failure.
     */    
    virtual int adjustUserPlaybackSignalVolumeEx(const char* userAccount, int volume, const RtcConnectionS& connectionS) = 0;

    /** Gets the current connectionS state of the SDK.
     @param connectionS The RtcConnectionS object.
     @return #CONNECTION_STATE_TYPE.
     */
    virtual CONNECTION_STATE_TYPE getConnectionStateEx(const RtcConnectionS& connectionS) = 0;
     ...
     */
    virtual int enableEncryptionEx(const RtcConnectionS& connectionS, bool enabled, const EncryptionConfig& config) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int createDataStreamEx(int* streamId, bool reliable, bool ordered, const RtcConnectionS& connectionS) = 0;
    /** Creates a data stream.
     *
     ...
     * - < 0: Failure.
     */
    virtual int createDataStreamEx(int* streamId, const DataStreamConfig& config, const RtcConnectionS& connectionS) = 0;
    /** Sends a data stream.
     *
     ...
     * - < 0: Failure.
     */
    virtual int sendStreamMessageEx(int streamId, const char* data, size_t length, const RtcConnectionS& connectionS) = 0;
    ...
    - < 0: Failure.
    */
    virtual int addVideoWatermarkEx(const char* watermarkUrl, const WatermarkOptions& options, const RtcConnectionS& connectionS) = 0;
    ...
    - < 0: Failure.
    */
    virtual int clearVideoWatermarkEx(const RtcConnectionS& connectionS) = 0;
    ...
    virtual int sendCustomReportMessageEx(const char* id, const char* category, const char* event, const char* label,
                                          int value, const RtcConnectionS& connectionS) = 0;
     ...
     * - < 0: Failure.
     */
    virtual int enableAudioVolumeIndicationEx(int interval, int smooth, bool reportVad, const RtcConnectionS& connectionS) = 0;
    ...
    /** Publishes the local stream without transcoding to a specified CDN live RTMP address.  (CDN live only.)
      ...
      * @param connectionS RtcConnectionS.
      *
      * @return
      * - 0: Success.
      * - < 0: Failure.
      */
    virtual int startRtmpStreamWithoutTranscodingEx(const char* url, const RtcConnectionS& connectionS) = 0;
    ...
    /** Publishes the local stream with transcoding to a specified CDN live RTMP address.  (CDN live only.)
      ...
      * - < 0: Failure.
      */
    virtual int startRtmpStreamWithTranscodingEx(const char* url, const LiveTranscodingS& transcodingS, const RtcConnectionS& connectionS) = 0;
    ...
    /** Update the video layout and audio settings for CDN live. (CDN live only.)
      ...
      * - < 0: Failure.
      */
    virtual int updateRtmpTranscodingEx(const LiveTranscodingS& transcodingS, const RtcConnectionS& connectionS) = 0;
    ...
    /** Stop an RTMP stream with transcoding or without transcoding from the CDN. (CDN live only.)
      ...
      * - < 0: Failure.
      */
    virtual int stopRtmpStreamEx(const char* url, const RtcConnectionS& connectionS) = 0;
  
    /** Starts relaying media streams across channels or updates the channels for media relay.
     *
     * @since v4.2.0
     * @param configuration The configuration of the media stream relay:ChannelMediaRelayConfigurationS.
     * @param connectionS RtcConnectionS.
     * @return
     * - 0: Success.
     * - < 0: Failure.
     ...
     */
    virtual int startOrUpdateChannelMediaRelayEx(const ChannelMediaRelayConfigurationS& configurationS, const RtcConnectionS& connectionS) = 0;
     ...
     */
    virtual int stopChannelMediaRelayEx(const RtcConnectionS& connectionS) = 0;
     ...
     *   - -7(ERR_NOT_INITIALIZED): cross channel media streams are not relayed.
     */
    virtual int pauseAllChannelMediaRelayEx(const RtcConnectionS& connectionS) = 0;
     ...
     *   - -7(ERR_NOT_INITIALIZED): cross channel media streams are not relayed.
     */
    virtual int resumeAllChannelMediaRelayEx(const RtcConnectionS& connectionS) = 0;
  ...
  /**
    ...
    * @param connectionS An output parameter which is used to control different connectionS instances.
    *
    * @return int
    * - 0 : Success.
    * - <0 : Failure.
    */
    virtual int setHighPriorityUserListEx(const char** userAccountList, int uidNum,
   ...
   * - < 0 : Failure.
   */
    virtual int takeSnapshotEx(const RtcConnectionS& connectionS, const char* userAccount, const char* filePath)  = 0;
    ...
    /**
     ...
     - 0: Success.
     - < 0: Failure.
      - -2(ERR_INVALID_ARGUMENT): The parameter is invalid. Check the channel ID and local userAccount set by parameter `connectionS`.
      - -7(ERR_NOT_INITIALIZED): The SDK is not initialized. Initialize the `IRtcEngine` instance before calling this method.
     */
    virtual int startMediaRenderingTracingEx(const RtcConnectionS& connectionS) = 0;

    /** Provides the technical preview functionalities or special customizations by configuring the SDK with JSON options.
    @since v4.3.0
    @param connectionS The connection information. See RtcConnection.
    @param parameters Pointer to the set parameters in a JSON string.
    @return
    - 0: Success.
    - < 0: Failure.
    */
    virtual int setParametersEx(const RtcConnectionS& connectionS, const char* parameters) = 0;
};
