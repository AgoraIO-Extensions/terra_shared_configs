...
struct UserAudioSpectrumInfoBase  {
  /**
   * The audio spectrum data of audio.
   */
  struct AudioSpectrumData spectrumData;

  UserAudioSpectrumInfoBase() {}

  UserAudioSpectrumInfoBase(const float* data, int length) : spectrumData(data, length) {}
};

/**
 * The IAudioSpectrumObserverBase class.
 */
class IAudioSpectrumObserverBase {
public:
  virtual ~IAudioSpectrumObserverBase() {}
...
class IVideoFrameObserverBase {
 ...
 public:
  virtual ~IVideoFrameObserverBase() {}
