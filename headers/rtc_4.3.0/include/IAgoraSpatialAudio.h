...
struct LocalSpatialAudioConfig {
   ...
   */
  IRtcEngine* __deprecated rtcEngine;

  LocalSpatialAudioConfig() : rtcEngine(NULL) {}
};

class ILocalSpatialAudioEngine : virtual public ISpatialAudioEngineBase {
protected:
...
public:
   ...
   *
   * @deprecated config The pointer to the LocalSpatialAudioConfig. See #LocalSpatialAudioConfig.
   *
   * @return
   * - 0: Success.
   * - <0: Failure.
